...
def inicio():
    ...
    label1 = Label(graficosMenu, text="Menú de graficos",
                   bg="white", fg="black")
    label1.place(x=140, y=10)

    label2 = Label(
        graficosMenu, text="Por favor selecione el tipo de grafico que desea ver:", bg="white", fg="black")
    label2.place(x=55, y=30)

    numerosCantados = Button(graficosMenu, text="Top 10 de números cantados",
                             command=graficoTopNumerosCantados, bg="white", fg="black")
    numerosCantados.place(x=105, y=60)

    frecuenciaConfiguracion = Button(graficosMenu, text="Frecuencia de configuración de partidas",
                                     command=graficoFrecuenciaConfiguracion, bg="white", fg="black")
    frecuenciaConfiguracion.place(x=77, y=100)

    fechaJugadas = Button(graficosMenu, text="Top 3 de fecha en que se jugaron más partidas",
                          command=graficoFechaJugadas, bg="white", fg="black")
    fechaJugadas.place(x=55, y=140)

    jugadoresGanadores = Button(graficosMenu, text="Top 5 de los jugadores que han ganado en más ocasiones",
                                command=graficoJugadoresGanadores, bg="white", fg="black")
    jugadoresGanadores.place(x=30, y=180)

    horarios = Button(graficosMenu, text="Distribución de horarios donde se ha jugado",
                      command=graficoHorarios, bg="white", fg="black")
    horarios.place(x=60, y=220)

    cantadosConfiguracion = Button(graficosMenu, text="Top 10 de números más cantados por configuración de partida",
                                   command=graficoCantadosConfiguracion, bg="white", fg="black")
    cantadosConfiguracion.place(x=15, y=260)

    segundaOpcion = Button(graficosMenu, text="Menú principal",
                           command=regresarMenu, bg="white", fg="black")
