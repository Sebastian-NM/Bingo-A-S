...
def interfaz():
    ...
    winGenerarCartones.geometry('%dx%d+%d+%d' % (window_width, window_height, position_top, position_right))

    label2=Label(winGenerarCartones,text="", bg="#B0E0E6", fg="black", font=("Finland", 10))
    label2.place(x=10,y=10)


    lblTitle=Label(winGenerarCartones,text="Ingrese la cantidad de cartones que desea generar", bg="#B0E0E6", fg="black", font=("Segoe UI bold", 13))
    lblTitle.place(x=45,y=10)

    cantidadCartones_StringVar = StringVar()

    ntryCantidadCartones = Entry(winGenerarCartones, bg="white", fg="black", textvariable=cantidadCartones_StringVar, width="25")
